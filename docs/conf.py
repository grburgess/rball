...
rtds_action_github_repo = "grburgess/rball"
...
latex_documents = [
    (master_doc, 'rball.tex', u'rball Documentation',
...
man_pages = [(master_doc, 'rball', u'rball Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'rball', u'rball Documentation', author, 'rball',
